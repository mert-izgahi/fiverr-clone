...
export {
  ...
  OverviewPage as DashboardOverviewPage,
  SettingsPage as DashboardSettingsPage,
  ConversationsListPage as DashboardConversationsListPage,
  ConversationsDetailsPage as DashboardConversationsDetailsPage,
  OrdersListPage as DashboardOrdersListPage,
  OrdersDetailsPage as DashboardOrdersDetailsPage,
  GigsListPage as DashboardGigsListPage,
